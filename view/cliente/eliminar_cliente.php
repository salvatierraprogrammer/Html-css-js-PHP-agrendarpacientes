...
<div class="container">
<br>
<h2 class="d-flex justify-content-center">Eliminar Cliente</h2><br>
<form action="delete_client.php" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este cliente?');">
